        ...
        <div class="container">
            <div class="row">
                ...
                <?php
                    ...
                    $search_content = mysqli_real_escape_string($db, $_POST['search']);
                        
                     $readData   = "SELECT * FROM post WHERE meta_tag LIKE '%$search_content%' AND post_status = 1 ORDER BY id DESC ";
                     ...
                     if( $total_post != 0){
                        ...
                        echo "<div class='alert alert-warning'> No Post Found based on your search content <strong>" . $search_content . "</strong> </div>";
                     }
                    } else if (isset($_GET['meta'])){

                        $meta_content = $_GET['meta'];
                        
                        $readData   = "SELECT * FROM post WHERE meta_tag LIKE '%$meta_content%' AND post_status = 1 ORDER BY id DESC ";
                     $postData   = mysqli_query($db, $readData);
                     $total_post = mysqli_num_rows($postData);
